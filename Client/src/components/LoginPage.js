...
export const LoginPage = (props) => {
  ...
  return (
    <>
      <div className="flex min-h-screen justify-center items-center flex-col px-6 py-12 lg:px-8 dark:bg-gray-800">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h2 className="mt-2 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 dark:text-gray-50">
